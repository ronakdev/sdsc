...
path4opencv                ='/home/ronakshah/opencv-3.1.0/data/haarcascades'
...
#Profile and close ups ------------------------------------------
               profilefaces=profile_face_cascade.detectMultiScale(gray, scaleFactor=1.05, minNeighbors=10, minSize=(int(imgw/8), int(imgh/8)))
               profilefaces=profile_face_cascade.detectMultiScale(gray, scaleFactor=1.05, minNeighbors=10, minSize=(int(imgw/8), int(imgh/8)))
...
#------- write summary info for queries
               ...
               if eyepaircnt==0:
                     eyesecdataset='-1'
               print(str(index)+sep2use+str(imgh)+sep2use+str(imgw)+\
                      ...
                      sep2use+str(pfullCloseUp)+sep2use+str(pmidCloseUp), file=ds_faces)
